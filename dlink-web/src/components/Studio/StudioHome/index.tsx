  ...
  return (
    <Scrollbars style={{ height: toolHeight }}>
      <Typography style={{ padding: '15px' }}>
        ...
        <Paragraph>
          <Text keyboard>{l('shortcut.key.checked')} + Tab</Text> {l('shortcut.key.indent')}{' '}
          <Divider type="vertical" />
          <Text keyboard>{l('shortcut.key.checked')} + Shift + Tab</Text>{' '}
          {l('shortcut.key.removeIndent')} <Divider type="vertical" />
          <Text keyboard>Shift + Alt + Right</Text> {l('shortcut.key.selectToEnd')}{' '}
          <Divider type="vertical" />
          <Text keyboard>Shift + Alt + F</Text> {l('shortcut.key.format')}
        </Paragraph>
        <Paragraph>
          <Text keyboard>Ctrl + Shift + Up/Down</Text> {l('shortcut.key.editMultiline')}{' '}
          <Divider type="vertical" />
          <Text keyboard>Shift + Alt + Up/Down</Text> {l('shortcut.key.copyRow')}{' '}
          <Divider type="vertical" />
        ...
        <Paragraph>
          ...
          <Text keyboard>Ctrl + Shift + F3</Text> {l('shortcut.key.matchPrevious')}{' '}
          <Divider type="vertical" />
        ...
        <Paragraph>
          <Text keyboard>Ctrl + Shift + End</Text> {l('shortcut.key.appendLineBefore')}{' '}
          <Divider type="vertical" />
          <Text keyboard>Ctrl + End</Text> {l('shortcut.key.appendLine')}{' '}
          <Divider type="vertical" />
          <Text keyboard>Alt + Up/Down</Text> {l('shortcut.key.transpositionUpAndDown')}{' '}
          <Divider type="vertical" />
