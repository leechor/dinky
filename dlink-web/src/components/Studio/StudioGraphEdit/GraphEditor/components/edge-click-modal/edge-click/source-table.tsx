...
import { FormOutlined, FileOutlined, CloseCircleOutlined, QuestionCircleOutlined, DeleteOutlined } from "@ant-design/icons";
...
const SourceTable: React.FC<SourceTableProps> = (props) => {
    ...
    const columns = [
        {
            title: () => (<span>{"字段名称"}<Tooltip title='映射字段名称'><QuestionCircleOutlined /></Tooltip></span>),
            dataIndex: "name",
            width: "20%",
            editable,
        },
