  ...
  return (
    <>
      {!isStencil && (
        <div className={styles['custom-calcu-node-head']}>
          <div style={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
            {node.prop().name ? node.prop().name : 'subProcess'}
          </div>
        </div>
      )}
      <div
      ...
      >
        ...
        <div
          className="custom-calcu-node-process-top"
          style={{ backgroundColor: `${isStencil ? '#FFF4DB' : '#fde4d7'}` }}
        >
        ...
        <div
          className="custom-calcu-node-process-bottom"
          style={{ backgroundColor: `${isStencil ? '#FFF4DB' : '#fde4d7'}` }}
        ></div>
      </div>
    </>
