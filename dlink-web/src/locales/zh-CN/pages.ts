...
export default {
  ...
  'pages.settings.FlinkNoUseSetting':
    '启用后，Flink 任务的 savepoint、停止等操作将通过 JobManager 的 RestAPI 进行',
  ...
  'pages.rc.clusterConfig.help.kubernetes.configfile':
    '默认~/.kube/config， 填写kube文件路径，可用作远程连接',
  ...
  'pages.rc.clusterConfig.help.kubernets.defaultTemplate':
    '可选，默认JobManager，TaskManager 的template配置!',
  'pages.rc.clusterConfig.help.kubernets.jobManagerTemplate':
    '可选，JobManager 的template配置! 会覆盖kubernetes.pod-template配置',
  'pages.rc.clusterConfig.help.kubernets.taskManagerTemplate':
    '可选，TaskManager 的template配置!会覆盖kubernetes.pod-template配置',
