  ...
  return (
    <>
      <ProTable
        ...
        toolBarRender={() => [
          <Badge
            color={taskStatus?.onlineStatus ? OPS_STATUS_COLOR.padding : OPS_STATUS_COLOR.success}
            text={
              <a
                onClick={() => {
                  onStatusChange('1');
              ...
              >
                {l('pages.devops.lable.allonline')}
              </a>
            }
          />,
          <a
          ...
          >
            {l('pages.devops.lable.onlinelist')}
          </a>,
          <Badge
            color={taskStatus?.offlineStatus ? OPS_STATUS_COLOR.padding : OPS_STATUS_COLOR.success}
            text={
              <a
                onClick={() => {
                  onStatusChange('2');
              ...
              >
                {l('pages.devops.lable.alloffline')}
              </a>
            }
          />,
          <a
          ...
          >
            {l('pages.devops.lable.offlinelist')}
          </a>,
        ]}
      ...
      />
      <OpsStatusModal
        opsStatusListTree={opsStatusListTree}
        opsStatusVisible={opsStatusVisible}
        opsStatus={opsStatus}
        onOpsStatusCallBack={onOpsStatusCallBack}
      />
      <StatusDetailedModal
        opsStatus={opsStatus}
        statusDetailedList={statusDetailedList}
