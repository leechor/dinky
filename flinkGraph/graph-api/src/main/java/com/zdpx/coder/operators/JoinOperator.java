...
public class JoinOperator extends Operator {
    ...
    public Optional<OperatorFeature> getOperatorFeature() {
        OperatorFeature operatorFeature = OperatorFeature.builder().icon("icon-join").build();
    ...
    protected Map<String, Object> formatOperatorParameter() {
        ...
        List<Map<String, String>> columnList =
                (List<Map<String, String>>) parameters.get("columnList");
        ...
        if (primaryInput.getConnection() != null) {
            ...
            primaryColumns =
                    primaryInput.getConnection().getFromPort().getPseudoData().getColumns();
    ...
    public List<FieldFunction> outPutFieldFunction(
