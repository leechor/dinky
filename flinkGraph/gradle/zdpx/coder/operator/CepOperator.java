...
public class CepOperator extends Operator {
    ...
    protected void execute() {
        ...
        var patternList = (List<Map<String, Object>>) parameters.get(PATTERNS);
        ...
        var sqlStr = TemplateUtils.format(this.getClass().getName(), result, TEMPLATE);
        this.getSchemaUtil().getGenerateResult().generate(sqlStr);

        var columns = Specifications.convertFieldFunctionToColumns(ffs);
    ...
    private <T> List<T> getSpecialTypeList(Map<String, Object> parameters, String key, Class<T> type) {
        var measureList = (List<Map<String, Object>>) parameters.get(key);
